...
use Illuminate\Http\Request;//manejar las variables getPost
use Illuminate\Support\Facades\Http;//manejar las variables getPost
use Illuminate\Support\Facades\Storage;//Alamacenar archivos
use Illuminate\Http\JsonResponse;//Generar salidas Json
...
class OpenAIController extends Controller
{
    ...
    private $nameChatBot='Tal-IA';

    // Modelo GPT para chat
    private $vicGptModel = "gpt-3.5-turbo-0301"; 

    //Primera linea de la personalidad de vicgpt. También le hacemos saber cómo se llama
    private $vicGptName = "YOUR NAME IS Tal-iA Remember that you have to MAINTAIN a PERSONALITY with effective Communication, Confidence, Positive Mentality, Ethics, Empathy and REALLY Knowledge of the product or service ALWAYS. Don't be repetitive."; 

    // Segunda linea de la personalidad de vicgpt
    private $vicGptSystem = "Use VERY SHORT answers. Maintain effective communication, Empathy, Positive mind, REALLY knowledgeable about the product or service ALWAYS. SPEAK IN SPANISH."; 
